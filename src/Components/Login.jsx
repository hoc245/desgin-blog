            ...
            <div className='popup-container'>
                ...
                <>
                    ...
                    <section className='form'>
                        <label htmlFor='email'>
                            <span class="material-symbols-outlined" aria-autocomplete='false' autoComplete={"off"}> mail </span>
                            <input type={"email"} id="email" name="email" placeholder='Email' />
                        </label>
                        <label htmlFor='password'>
                            <span class="material-symbols-outlined" aria-autocomplete='false' autoComplete={"off"}> lock </span>
                            <input type={"password"} id="password" name="password" placeholder='Password' />
                        </label>
                        <label htmlFor='checkbox' onClick={() => {handleSaveLogin()}}>
                    ...
                    <Button value={"Forgot your password"} state="is-ghost" isSmall={true} />
                    <p>Don't have an account yet? <span onClick={() => {setSignUp(true)}}>Sign up here</span></p>
                </>
                 : 
                <>
                    <section className='popup-title'>
                    ...
                    <section className='form'>
                        ...
                        <div className='jobs-dropdown' onClick={(e) => {e.currentTarget.lastChild.classList.toggle('is-active')}}>
                            ...
                            <ul className='jobs-dropdown-menu'>
                                <li className='jobs-dropdown-item' onClick={(e) => {handleJob(e)}}>Graphic Designer</li>
                                <li className='jobs-dropdown-item' onClick={(e) => {handleJob(e)}}>UI/UX Designer</li>
                                <li className='jobs-dropdown-item' onClick={(e) => {handleJob(e)}}>Product Designer</li>
                                <li className='jobs-dropdown-item' onClick={(e) => {handleJob(e)}}>Interaction Designer</li>
                                <li className='jobs-dropdown-item' onClick={(e) => {handleJob(e)}}>Other</li>
                            </ul>
                        </div>
                    ...
                    <p>Already have an account? <span onClick={() => {setSignUp(false)}}>Sign up here</span></p>
                </>
                }
            </div>
