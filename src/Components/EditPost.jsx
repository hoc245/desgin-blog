...
export default function EditPost(props) {
  ...
  const newPost = async () => {
    ...
    if (valid) {
      ...
      if(!file) {
        ...
        await set(ref(db, `/postDetail/${mPost.createAt}`), mPost).then(() => {
  ...
  const checkValid = () => {
    ...
    const creatorID = document.querySelector(
      ".post-creator .dropdown-catalogies-title-value"
    ).getAttribute('data-id');
            ...
            <div className="popup-container">
              ...
              <section className="post-option">
                ...
                <div className="post-create-source">
                  ...
                  <input type={"text"} placeholder={"Link to post source"} defaultValue={postDetail.source}/>
                </div>
                ...
                <div className="post-creator">
                  ...
                  <div className="dropdown-catalogies">
                    ...
                    >
                      <span className="dropdown-catalogies-title-value" data-id={postDetail.creator ? postDetail.creator : ""}>
                        {userList[`${postDetail.creator}`] ? userList[`${postDetail.creator}`].name : "Choose a creator"}
                      </span>
                      <span class="material-symbols-outlined">
                        navigate_next
                      </span>
                    ...
                    <div className="dropdown-catalogies-menu">
                      {props.userList && Object.keys(userList).map(user => {
                        return (
                          <div className="dropdown-catalogies-item" onClick={() => handleCreator(user)}>
                            <img src={userList[`${user}`].image} alt="avatar"/>
              ...
              <section className="post-banner">
                ...
                <div className="post-banner-link">
                  ...
                  <input type={"text"} placeholder={"Banner link"} defaultValue={postDetail.image}/>
                </div>
              </section>
              <section className="post-content">
                <h3>Title (Required)</h3>
                <textarea className="post-content-header" rows={3} defaultValue={postDetail.title} onChange={(e) => {handleTitle(e)}} maxLength={160}></textarea>
                <h3>Sub-title</h3>
                <textarea className="post-content-sub" rows={3} defaultValue={postDetail.description} onChange={(e) => {handleSubTitle(e)}} maxLength={160}></textarea>
                <h3>Main (Required)</h3>
                <Editor
