                    ...
                    <>
                        {!loginState ? 
                            <div className="nav-right">
                                <Button value={"Create a post"} iconLeft="add" state="is-outline" onClick={() => {triggerPopup(true)}}/>
                                <Link to={"/About"} ><Button value={"About us"} state={"is-ghost"}/></Link>
                                <Button value={"Sign In"} onClick={() => {setTriggerLogin(true)}}/>
                            </div> : 
                            <div className="nav-right">
                                <Button value={"Create a post"} iconLeft="add" state="is-outline" onClick={() => {triggerPopup(true)}}/>
                                <Link to={"/About"} ><Button value={"About us"} state={"is-ghost"}/></Link>
                                <div className="nav-user" onClick={(e) => {e.currentTarget.lastChild.classList.toggle('is-active')}}>
                                    <img src={`${user && user.image}`} alt="user-image"/>
                                    <ul className="nav-user-dropdown">
                                        <li className="--dropdown-item" onClick={() => {}}><Link to="/Result/Saved">Saved post</Link></li>
                                        <li className="--dropdown-item" onClick={() => {}}>Account</li>
