        ...
        <div className="main-content">
          <section className="about">
            <div className="about-item">
              ...
              <div className="about-content">
                <h2>Update news</h2>
                <p>
                  Are you passionate about Design? Do you want to keep up the
                  latest trends and outstanding news in the Design department?
                  Come to Conando Design News - a place that summarizes for you
                  the latest information related to Graphic Design and UI / UX
                  Design department, help keeping you updated and inspired at
                  work.
                </p>
                <ul>
          ...
          <section className="review">
            <div className="review-title">
              <h3>Let's see how users think about us</h3>
            </div>
            <div className="review-slider">
              <div className="review-left">
                <h2>User stories</h2>
                <p>
                  Learn how our services have helped users from all backgrounds
                  enhance knowledge in Design.
                </p>
                <Button
              ...
              <div className="review-right">
                <div
                  className={`${
                    current === 0 ? "review-item is-active" : "review-item"
                  }`}
                  style={style}
                >
                ...
                <div
                  className={`${
                    current === 1 ? "review-item is-active" : "review-item"
                  }`}
                  style={style}
                >
                  <div className="review-item-user">
                ...
                <div
                  className={`${
                    current === 2 ? "review-item is-active" : "review-item"
                  }`}
                  style={style}
                >
                  <div className="review-item-user">
